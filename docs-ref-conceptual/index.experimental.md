...
layout: HubPage
hide_bc: true
title: Centro de Desenvolvimento do Node.js | Microsoft Docs
description: Saiba como desenvolver e implantar aplicativos Node.js na nuvem com o Azure.
ms.topic: hub-page
...
ms.locfileid: "48488535"
---
<div id="main" class="v2">
    <div class="container">
        <h1 style="text-align: center">Central de Desenvolvimento do Node.js</h1> 
        <p style="text-align: center">Crie, implante e dimensione seus aplicativos Node.js na nuvem do Azure.</p>
